...
public class DBConstants {
    ...
    public static final String CHECK_IF_VEHICULE_COME_ONCE = "SELECT COUNT(*) AS VISIT_TIMES, VEHICLE_REG_NUMBER FROM ticket GROUP BY VEHICLE_REG_NUMBER HAVING COUNT(*) > 1"; 
}
